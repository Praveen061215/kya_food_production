    ...
    <script src="<?php echo strpos($_SERVER['REQUEST_URI'], '/modules/') !== false ? '../../' : ''; ?>assets/js/chatbot.js"></script>
    ...
    <!-- KYA Assistant Chatbot Widget -->
    <div class="kya-chatbot-launcher" id="kyaChatbotLauncher" title="KYA Assistant">
        <i class="fas fa-comments"></i>
    </div>
    
    <div class="kya-chatbot-panel d-none" id="kyaChatbotPanel">
        <div class="kya-chatbot-header">
            <div class="kya-chatbot-title">KYA Assistant</div>
            <button type="button" class="btn-close btn-close-white" id="kyaChatbotClose" aria-label="Close"></button>
        </div>
        <div class="kya-chatbot-body">
            <div class="kya-chatbot-messages" id="kyaChatbotMessages"></div>
            <div class="kya-chatbot-typing d-none" id="kyaChatbotTyping">
                <span class="kya-typing-dot"></span>
                <span class="kya-typing-dot"></span>
                <span class="kya-typing-dot"></span>
            </div>
        </div>
        <form class="kya-chatbot-footer" id="kyaChatbotForm">
            <input type="text" class="form-control form-control-sm" id="kyaChatbotInput" placeholder="Ask about inventory, expiry, processing, reports..." autocomplete="off">
